...
if(isset($_GET['do']) && $_GET['do'] == "actv-member"){
    ...
    if($query){
        ...
        $msg = "$curAdminID activated a pending member ($nm) account";
        $log = logActivity($msg);
        if($log == 'success'){
                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <?php
                                            $cntRows = mysqli_query($dbConn, "SELECT * FROM action_logs");
                                            $cntRowsAct = mysqli_query($dbConn, "SELECT * FROM action_logs");
                                            $cntRowsInact = mysqli_query($dbConn, "SELECT * FROM action_logs");
                                            ?>
                                            <h6><?php echo mysqli_num_rows($cntRows); ?></h6>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills mb-3" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="<?php echo $adminURL; ?>home?shw-pend=members" class="nav-link <?php if(isset($_GET['shw-pend']) && $_GET['shw-pend'] == "members"){ echo "active"; } ?>">Members</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade show <?php if(isset($_GET['shw-pend']) && $_GET['shw-pend'] == "members"){ echo "active"; } ?>">
                                        <div class="table-responsive x-scroll">
                                            <table class="table datatable">
                                                <thead class="thead-dark">
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $No=1;
                                                    $query = mysqli_query($dbConn, "SELECT * FROM members WHERE status='Pending'");
                                                    while($row=mysqli_fetch_array($query)){
                                                        $mId = $row['id'];
                                                        $ID = $row['memberID'];
                                                        $username = $row['username'];
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="<?php echo $adminURL; ?>home?do=actv-member&shw-pend=members&nm=<?php echo $username; ?>&id=<?php echo $mId; ?>" class="btn btn-outline-primary btn-sm" title="Activate"><i class="fa fa-check"></i></a>
                                                            </div>
                                                        </td>
                                                        <td><a href=""><?php echo $ID; ?></a></td>
                                                        <td><?php echo $username; ?></td>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="activity">
                                <?php
                                $query = mysqli_query($dbConn, "SELECT * FROM action_logs ORDER BY dCreated DESC LIMIT 20");
