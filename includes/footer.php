<footer class="footer--section">
    ...
    <div class="footer--widgets pt--70 pb--20 bg-lightdark" data-bg-img="assets/img/footer-img/footer-widgets-bg.png">
        <div class="container">
            ...
            <div class="widget">
                ...
                <div class="recent-active-members--widget style--2">
                    <div class="owl-carousel" data-owl-items="12" data-owl-nav="true" data-owl-speed="1200" data-owl-responsive='{"0": {"items": "3"}, "481": {"items": "6"}, "768": {"items": "8"}, "992": {"items": "12"}}'>
                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/01.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/02.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/03.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/04.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/05.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/06.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/07.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/08.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/09.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/10.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/11.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/12.jpg" alt=""></a>
                        </div>

                        <div class="img">
                            <a href="#"><img src="assets/img/widgets-img/recent-active-members/13.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer--copyright pt--30 pb--30 bg-darkest">
        <div class="container">
            <div class="text fw--500 fs--14 text-center">
                &copy; <?php echo date("Y"); ?> Copyright <strong><span>CIW 2022</span></strong>. All Rights Reserved
            </div>
        </div>
    </div>
